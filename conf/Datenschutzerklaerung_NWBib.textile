h1. Datenschutzerklärung NWBib – Stand 06.07.2018
...
gewährleistet werden kann. Für die technische Organisation und Verarbeitung der
Daten in der Nordrhein-Westfälischen Bibliographie (NWBib) ist das 
Hochschulbibliothekszentrum NRW zuständig, für die Qualität der Daten die 
Universitäts- und Landesbibliotheken Bonn, Düsseldorf und Münster
(Zuständigkeitsbereich und Kontaktinformationen für letztere finden sich im
Abschnitt 8.5 oder auf der Seite unter dem "i"-Icon).
...
unserer Nutzer auf den lobid-Seiten. Dafür werten wir unsere Logdateien aus, die bei Aktivität des Nutzers 
mit folgenden Daten befüllt werden:
...
*51* In der NWBib werden Daten der Gemeinsamen
Normdatei (GND) der Deutschen Nationalbibliothek (DNB) verwendet. Dies sind 
Namen von Autoren, sonstigen am Werk beteiligten Personen und Personen, die 
Thema des Werk sind und als Schlagwort verwendet werden. Aus dem Verbundkatalog
...
*52* Rechtsgrundlage für die Verarbeitung personenbezogener Daten ist Art. 6 
Abs. 1 lit. e DSGVO. Das öffentliche Interesse äußert sich im Auftrag des
Landes Nordrhein-Westfalen an die zuständigen Bibliotheken und das hbz
(für das hbz siehe §2 Abs. 3 Pflichtexemplargesetz Nordrhein-Westfalen).

h3. 8.3 Zweck der Datenverarbeitung

*53* Die Verarbeitung der personenbezogenen Daten dient dazu, bibliothekarische
Dienstleistungen anzubieten. Ohne diese Daten können Autoren und andere 
beteiligte Personen nicht einem Werk zugeordnet bzw. unterschieden werden. 
Gleiches gilt für das Setzen von Schlagwörtern. In diesen Zwecken liegt auch
...
verschiedene E-Mail-Adressen an die passenden Stellen wenden. Auf der Startseite
https://nwbib.de findet sich eine Karte. 
Die dort grün markierten Kreise und kreisfreien Städte im westlichen Bereich NRWs 
liegen in der Zuständigkeit der Universitäts- und Landesbibliothek (ULB) Düsseldorf 
(Kontaktadressen siehe "ULB Düsseldorf-Webseite(ULB Düsseldorf)":https://www.ulb.hhu.de/ueberblick-gewinnen/ansprechpartnerinnen-und-ansprechpartner.html#nwbib.
Die rot markierten Bereiche liegen in der Zuständigkeit der ULB Münster (Kontaktadressen
unter der "ULB Münster-Webseite(ULB Münster)":https://www.ulb.uni-muenster.de/landesbibliothek/profil/ansprechpartner/index.html).
Für selbstständige Werke, die dem Pflichtexemplarrecht unterliegen, sollte die ULB
Bonn kontaktiert werden ("Kontaktperson der ULB Bonn(Kontaktperson der ULB Bonn)":https://www.ulb.uni-bonn.de/de/die-ulb/organisation-ansprechpartner/ansprechpartner-von-a-z/albrink).
Einen Tag nach der Korrektur in der GND bzw. im Verbundkatalog sind die Daten in der
NWBib aktualisiert.
...
|1.1|05.06.2018|Aktualisierung Rechtsgrundlage.|
|1.2|06.07.2018|Ergänzung zur Aufgabenteilung zwischen hbz und den Landesbibliotheken.|
